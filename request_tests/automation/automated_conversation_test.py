import pytest
from request_tests.automation.test_plan_loader import getDialogflowMessagesPlan, getSignupPlan, getFullPathPlan
from request_tests.automation.test_utils import colorize, less_strict_comparison
from request_tests.calls.sendHttpCalls import sendTwilioRequest, convertResponseToUtf8, sendInstagramRequest, \
